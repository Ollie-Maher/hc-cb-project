...
# dp_hc_allo = "/home/rh19400/neuro-rl/exp_local/2024.02.11/214909_drqn_agent=drqn,experiment=rnd_allo,save_stats=true,seed=1,use_wandb=false/activations"
# dp_hc_allo = "/home/rh19400/neuro-rl/exp_local/2024.02.12/100415_drqn_agent=drqn,experiment=rnd_allo,save_stats=true,seed=1,use_wandb=false/activations"

# s1 test
# dp_hc_state_allo = "/home/rh19400/neuro-rl/exp_local/2024.02.12/112629_hccstate_agent=hccstate,experiment=test_rnd_allo,save_stats=true,seed=1/activations"
# s2 change starting location
# dp_hc_state_allo = "/home/rh19400/neuro-rl/exp_local/2024.02.12/113916_hccstate_agent=hccstate,experiment=test_rnd_allo,save_stats=true,seed=1/activations"

# s1 test trained at 2k
dp_hc_state_allo = "/home/rh19400/neuro-rl/exp_local/2024.02.12/123423_hccstate_agent=hccstate,experiment=test_rnd_allo,save_stats=true,seed=1/activations"

dp_hc_state_allo = "/home/rh19400/neuro-rl/exp_local/2024.02.12/124027_hccstate_agent=hccstate,experiment=test_rnd_allo,save_stats=true,seed=1/activations"
...
plc_hc, bdc_hc, axis = _single_env_viz_unit_chart(
    name="hc_state_allo_ca1", axes=axs_unit_hc
)
...
start_idx = 0
end_idx = 6
model_names = ["hc_state_allo", "hc_state_allo"]
for name in model_names:
    df_ca1, df_ca3 = get_df(eval(f"dp_{name}"))
    data_ca1 = get_neurons_hm(df_ca1)
    data_ca3 = get_neurons_hm(df_ca3)
    ...
    plot_neurons_hm(
        ...
        idxs=eval(f"plc_hc")[start_idx:end_idx],
    )
    start_idx += 6
    end_idx += 6
    plot_neurons_hm(
