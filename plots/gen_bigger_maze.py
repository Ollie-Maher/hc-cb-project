...
## fixed hc-cb ##
##bigger maze
# data_path_bio_hc_cb = "/home/rh19400/neuro-rl/exp_local/2024.01.12/184416_hccbio_agent=hccbio,experiment=wm,save_stats=true,seed=1/locations"
##### Fixed model ####
## hc fixed 10k trained steps
# data_path_hc = "/home/rh19400/neuro-rl/exp_local/2024.01.12/194153_drqn_agent=drqn,experiment=wm_fixed_s,save_stats=true,seed=5/locations"
...
# intermediate maze
data_path_bio_hc_cb = "/home/rh19400/neuro-rl/exp_local/2024.01.13/134756_hccbio_agent=hccbio,experiment=wm,save_stats=true,seed=1/locations"
data_path_hc = "/home/rh19400/neuro-rl/exp_local/2024.01.13/140303_drqn_agent=drqn,experiment=wm_fixed_s,save_stats=true,seed=5/locations"
data_path_hc_cb = "/home/rh19400/neuro-rl/exp_local/2024.01.13/142406_hcc_agent=hcc,experiment=wm_s,save_stats=true,seed=1/locations"

##obstacle in intermediate maze
# data_path_bio_hc_cb = "/home/rh19400/neuro-rl/exp_local/2024.01.13/144628_hccbio_agent=hccbio,experiment=wm,save_stats=true,seed=1/locations"
# data_path_hc = "/home/rh19400/neuro-rl/exp_local/2024.01.13/161255_drqn_agent=drqn,experiment=wm_fixed_s,save_stats=true,seed=5/locations"
# data_path_hc_cb = "/home/rh19400/neuro-rl/exp_local/2024.01.13/164413_hcc_agent=hcc,experiment=wm_s,save_stats=true,seed=1/locations"

# obstacle below in intermediate maze
# data_path_bio_hc_cb = "/home/rh19400/neuro-rl/exp_local/2024.01.13/171614_hccbio_agent=hccbio,experiment=wm,save_stats=true,seed=1/locations"
# data_path_hc = ""
# data_path_hc_cb = ""
...
def plot_env(ax1):
    start_pos = [[1.5, 9.0], [9.0, 4.5], [3.5, 5.5], [2.5, 1.5]]
    colors = {
    ...
    img = plt.imread("td_big_wm.png")
    ax1.imshow(img, extent=[0, 11, 0, 11])
...
def plot_all(models):
    ...
    gs = plt.GridSpec(4, 8, wspace=1.5, hspace=1.0)
    ax_im = fig.add_subplot(gs[0:2, 0:2])
    ax1 = fig.add_subplot(gs[0:2, 2:4])
    ax2 = fig.add_subplot(gs[0:2, 4:6])
    ax3 = fig.add_subplot(gs[0:2, 6:8])
    ...
    ax_im.set_position([0.10, 0.55, 0.18, 0.18])
    # axes[0].set_xlim([0, 15])
    axes[0].set_position([0.32, 0.55, 0.18, 0.18])
    axes[1].set_position([0.52, 0.55, 0.18, 0.18])
    axes[2].set_position([0.72, 0.55, 0.18, 0.18])


    # Function to rescale from 0-10 to 0-15
    def rescale_to_15(x, pos):
        return f"{x * 1.5}"

    # Set the formatter for the x-axis
    from matplotlib.ticker import FuncFormatter
    for ax in axes:
        ax.xaxis.set_major_formatter(FuncFormatter(rescale_to_15))
        ax.yaxis.set_major_formatter(FuncFormatter(rescale_to_15))
    ax_im.xaxis.set_major_formatter(FuncFormatter(rescale_to_15))
    ax_im.yaxis.set_major_formatter(FuncFormatter(rescale_to_15))
    ...
    ax2.text(
        1.2, 1.10, "B", transform=ax_im.transAxes, fontsize=18, weight="bold"
    )  # 'a'
    ax3.text(
        -0.3, -0.40, "C", transform=ax_im.transAxes, fontsize=18, weight="bold"
    )  # 'a'

    plt.tight_layout()
    plt.show()
    fig.savefig("gen_big.pdf", bbox_inches="tight")
