...
### gen_start models ###
dp_hc_gen_start = "/home/rh19400/neuro-rl/exp_local/2024.01.13/120706_drqn_agent=drqn,experiment=wm_fixed_s,save_stats=true,seed=5/activations"
dp_hc_cb_gen_start = "/home/rh19400/neuro-rl/exp_local/2024.01.13/124747_hcc_agent=hcc,experiment=wm_s,save_stats=true,seed=1/activations"
dp_bio_hc_cb_gen_start = "/home/rh19400/neuro-rl/exp_local/2024.01.13/122537_hccbio_agent=hccbio,experiment=wm,save_stats=true,seed=1/activations"

### gen_big models ###
dp_hc_gen_big = "/home/rh19400/neuro-rl/exp_local/2024.01.13/140303_drqn_agent=drqn,experiment=wm_fixed_s,save_stats=true,seed=5/activations"
dp_hc_cb_gen_big = "/home/rh19400/neuro-rl/exp_local/2024.01.13/142406_hcc_agent=hcc,experiment=wm_s,save_stats=true,seed=1/activations"
dp_bio_hc_cb_gen_big = "/home/rh19400/neuro-rl/exp_local/2024.01.13/134756_hccbio_agent=hccbio,experiment=wm,save_stats=true,seed=1/activations"

### gen_noisy models ###
dp_hc_gen_noisy = "/home/rh19400/neuro-rl/exp_local/2024.01.13/200634_drqn_agent=drqn,experiment=wm_fixed_s,save_stats=true,seed=5/activations"
...
model_names_og = ["hc", "hc_cb", "bio_hc_cb"]
model_names_start = ["hc_gen_start", "hc_cb_gen_start", "bio_hc_cb_gen_start"]
...
for name, n_start in zip(model_names_og, model_names_start):
    ...
    max_idx_ca1 = get_max_index(data_ca1, eval(f"plc_{name}_intersection"))
    max_idx_ca1_start = get_max_index(data_ca1_start, eval(f"plc_{name}_intersection"))

    max_idx_ca1_bdc = get_max_index(data_ca1, eval(f"bdc_{name}_intersection"))
    max_idx_ca1_start_bdc = get_max_index(
        data_ca1_start, eval(f"bdc_{name}_intersection")
    )
    ...
    print(name, count, distance.mean())
    ...
    hm_one_idx = np.where(distance == 1)[0]
