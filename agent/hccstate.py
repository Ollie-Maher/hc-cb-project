...
class RecurrentQNet(nn.Module):
    ...
    def forward(self, x, hidden=None, cereb_pred=None, neurons_reset_idx=None):
        ...
        # print("neurons_reset_idx", neurons_reset_idx)
        # print("ca1_out before", ca1_out)
        # print("ca1_out before reset", ca1_out[:, -1, neurons_reset_idx])
        if neurons_reset_idx is not None:
            ca1_out[:, -1, neurons_reset_idx] = 0.0
        # print("ca1_out after reset", ca1_out[:, -1, neurons_reset_idx])
        # print("ca1_out", ca1_out)
